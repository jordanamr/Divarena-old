...
public class CoachesRecord extends UpdatableRecordImpl<CoachesRecord> implements Record11<Integer, Integer, String, Byte, Byte, Byte, Integer, Integer, Integer, Integer, byte[]> {

    private static final long serialVersionUID = 1771145922;
    ...
    @Override
    public Row11<Integer, Integer, String, Byte, Byte, Byte, Integer, Integer, Integer, Integer, byte[]> valuesRow() {
    ...
    @Override
    public CoachesRecord values(Integer value1, Integer value2, String value3, Byte value4, Byte value5, Byte value6, Integer value7, Integer value8, Integer value9, Integer value10, byte[] value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CoachesRecord(Integer id, Integer accountId, String name, Byte skinColor, Byte hairColor, Byte sex, Integer instance, Integer x, Integer y, Integer z, byte[] inventory) {
        super(Coaches.COACHES);
