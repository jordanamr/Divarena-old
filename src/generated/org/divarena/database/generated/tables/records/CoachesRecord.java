...
public class CoachesRecord extends UpdatableRecordImpl<CoachesRecord> implements Record12<Integer, Integer, String, Byte, Byte, Byte, Integer, Integer, Integer, Integer, byte[], byte[]> {

    private static final long serialVersionUID = 205401593;
    ...
    @Override
    public Row12<Integer, Integer, String, Byte, Byte, Byte, Integer, Integer, Integer, Integer, byte[], byte[]> valuesRow() {
    ...
    @Override
    public CoachesRecord values(Integer value1, Integer value2, String value3, Byte value4, Byte value5, Byte value6, Integer value7, Integer value8, Integer value9, Integer value10, byte[] value11, byte[] value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CoachesRecord(Integer id, Integer accountId, String name, Byte skinColor, Byte hairColor, Byte sex, Integer instance, Integer x, Integer y, Integer z, byte[] inventory, byte[] equipment) {
        super(Coaches.COACHES);
